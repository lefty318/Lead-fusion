...
"""
    ...
    print(f"📝 Please update DATABASE_URL and other settings as needed")
    return True
...
def check_migrations():
    ...
    if not versions_dir.exists():
        print("⚠️  No migrations found. Run: alembic revision --autogenerate -m 'Initial migration'")
        return False
